    ...
    <div class="w-[80%] flex flex-col items-center gap-24 justify-between">
        ...
        <form class="flex flex-col items-center gap-6" action="process/Connexion.php" method="POST">
            <div class="w-full flex flex-col items-center">
                <input id="input_pseudo" tabindex="0" class="w-full bg-white text-center placeholder-black focus:bg-gray-200" type="text" minlength="3" maxlength="30" placeHolder="Entrez votre pseudo">
            </div>
